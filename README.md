This is a [React](https://reactjs.org/) project using the [Next.js](https://nextjs.org/) toolchain bootstrapped with [`create-next-app`](https://github.com/vercel/next.js/tree/canary/packages/create-next-app).
## Features (WIP)
